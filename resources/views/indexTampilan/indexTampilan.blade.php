...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('dist/img/index.png') }}">
    ...
    <style>
        ...
        .showkan .navSide-item {
            opacity: 1;
            transform: translateX(0);
        }

        /* Delayed animation for each nav item */
        .navSide-item:nth-child(1) {
            transition-delay: 0.1s;
        }

        .navSide-item:nth-child(2) {
            transition-delay: 0.2s;
        }

        .navSide-item:nth-child(3) {
            transition-delay: 0.3s;
        }

        .navSide-item:nth-child(4) {
            transition-delay: 0.4s;
        }

        .navSide-item:nth-child(5) {
        ...
        .navSide-item .btn-success:hover {
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="{{url('/login')}}"><button type="button" class="btn btn-success">SignIn</button></a>
                    </li>
                </ul>
            </div>
            ...
            <div class="sidebarEco">
                ...
                <ul class="navbar-side">
                    ...
                    <li class="navSide-item">
                        <a href="{{url('/login')}}" class="a-sidebar">
