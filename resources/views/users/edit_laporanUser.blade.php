    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="card col-10 p-0">
                ...
                <div class="card-body">
                    <form action="{{ url($reports->id. '/update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="input1">Judul Laporan</label>
                            <input type="text" class="form-control" id="input1" name="judul_laporan" value="{{ $reports->judul_laporan }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="input3" name="description" value="{{ $reports->description }}">
                        </div>
