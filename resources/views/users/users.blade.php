                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <tbody class="tbody">
                                            ...
                                            <!-- Menampilkan hanya laporan yang dimiliki pengguna -->
                                            <tr>
                                                <th scope="row">{{ $id++; }}</th>
                                                ...
                                                <td>
                                                    ...
                                                    <img src="{{ asset('storage/reports/' . $report->gambar) }}"
                                                        alt="Gambar Laporan" style="max-width: 100px; height: auto;">
                                                    @else
                                                    Tidak ada gambar
                                                    @endif
                                                </td>
                                                ...
                                                <td><a href="{{ url($report->id . '/edit') }}"
                                                        class="btn btn-warning">Edit</a></td>
                                                <td><a href="{{ url($report->id . '/delete') }}"
